...
{
    public class GetDepartmentDetailDtoValidator : AbstractValidator<GetDepartmentDetailDto>
    {
        private readonly IDepartmentsRepository _DepartmentRepository;
        public GetDepartmentDetailDtoValidator(IDepartmentsRepository DepartmentsRepository)
        {
